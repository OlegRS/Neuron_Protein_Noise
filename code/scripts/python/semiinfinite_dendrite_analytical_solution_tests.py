...
axs[1,1].plot(np.arange(0,len(G2_m2_discrete)*5000/n_comps-.001,5000/n_comps), G2_m2_discrete*n_comps/5000, label="G2_discrete_10")
# axs[1,1].plot(np.arange(0,len(G2_m2_discrete_100)*5000/101-.001,5000/101), G2_m2_discrete_100*101/5000, label="G2_discrete_101")
axs[1,1].plot(np.arange(0,len(G2_m2_discrete_)*5000/n_comps-.001,5000/n_comps), G2_m2_discrete_*n_comps/5000, label="G2_discrete_10_")
