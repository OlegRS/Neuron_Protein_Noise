...
#   axs_avrg[2].plot(data[:,0], data[:,15], label="Spine_1-2_2", alpha=.5, color='pink')
...
# axs_avrg[2].plot(averages[:,0], averages[:,10], label="Spine_1_1", color='maroon', alpha=.7)
# axs_avrg[2].plot(num[:,0], averages[:,10] + variances[:,10], linestyle='--', color='maroon')
# axs_avrg[2].plot(num[:,0], averages[:,10] - variances[:,10], linestyle='--', color='maroon')
# axs_avrg[2].plot(averages[:,0], averages[:,11], label="Spine_1_2", alpha=.7)
# axs_avrg[2].plot(averages[:,0], averages[:,12], label="Spine_1-1_1", alpha=.7)
# axs_avrg[2].plot(averages[:,0], averages[:,13], label="Spine_1-1_2", alpha=.7)
# axs_avrg[2].plot(averages[:,0], averages[:,14], label="Spine_1-2_1", alpha=.5, color='red')
# axs_avrg[2].plot(num[:,0], averages[:,14] + variances[:,14], linestyle='--', color='red')
# axs_avrg[2].plot(num[:,0], averages[:,14] - variances[:,14], linestyle='--', color='red')
# axs_avrg[2].plot(averages[:,0], averages[:,15], label="Spine_1-2_2", alpha=.5, color='pink')
