...
num_exp = np.genfromtxt("../for_cosyne/data/stationary_expectations_2_genes", delimiter=',')
num_std = np.genfromtxt("../for_cosyne/data/stationary_stds_2_genes", delimiter=',')
...
for file_id in range(sim_run_count_1):
    ...
    file_name = "../for_cosyne/data/SM_" + str(file_id+2)
    print(file_name)
    data = np.genfromtxt(file_name, delimiter=',')[:, 1:]
    averages_1[:, 1:] += data[:, 1:]/sim_run_count_1
    variances_1[:, 1:] += data[:, 1:]**2/sim_run_count_1

averages_2 = np.genfromtxt("../for_cosyne/data/stationary_averages_500.csv", delimiter=',')
...
stds_2 = np.genfromtxt("../for_cosyne/data/stationary_stds_500.csv", delimiter=',')
