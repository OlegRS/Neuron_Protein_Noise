...
public:
  Soma(const std::string& name="no_name") : Compartment(name), gene_activation(this), gene_deactivation(this) {
    ...
    translation_rate = 0.021*3600 * 1e-2;
    mRNA_decay_rate = 1.2e-5*3600;
    protein_decay_rate = 1.21e-6*3600 * 1e-2;
