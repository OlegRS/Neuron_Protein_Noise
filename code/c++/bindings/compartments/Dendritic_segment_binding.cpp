...
void bind_Dendritic_segment(py::module& m) {
  py::class_<Dendritic_segment, Compartment>(m, "Dendritic_segment")
    .def(py::init<Compartment&, const std::string&, const double&,  const double&, const double&, const double&, const double&, const double&, const double&, const double&, const double&, const double&, const double&, const double&, const double&>(),
         py::arg("parent"), py::arg("name")="no_name_Dendritic_segment", py::arg("length")=10, py::arg("radius")=5, py::arg("d_theta")=0, py::arg("d_phi")=0, py::arg("mRNA_decay_rate")=0.0432, py::arg("translation_rate")=75.6, py::arg("protein_decay_rate")=0.004356, py::arg("mRNA_diffusion_constant")=1.082e-5, py::arg("protein_diffusion_constant")=7.6e-4, py::arg("mRNA_forward_trafficking_velocity")=1.59e-5, py::arg("mRNA_backward_trafficking_velocity")=3.18e-6, py::arg("protein_forward_trafficking_velocity")=0, py::arg("protein_backward_trafficking_velocity")=0, 
