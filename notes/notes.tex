...
\section{Equations for averages in continuous limit}
In this section we establish a correspondence of the parameters of our model with those of the continuous drift-diffusion model from \cite{PMID:31350097}. This allows us using the parameters from \cite{PMID:31350097} to set the hopping rates in our model.
...
\begin{equation*}
  \nu_{\alpha,\beta} \equiv D_{\alpha,\beta} + v_{\alpha,\beta},
\end{equation*}
where
\begin{equation*}
