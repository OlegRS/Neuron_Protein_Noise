...
\begin{equation}
  \frac{\partial P(\xi, t)}{\partial t} = \frac{\partial}{\partial\xi} \left[ D_p(\xi, t)\frac{\partial P(\xi,t)}{\partial\xi}\right] - \frac{\partial}{\partial\xi}\left[v_p(\xi,t)P(\xi,t)\right] - \frac{1}{\tau_3}P(\xi,t) + \kappa_3(\xi,t)R(\xi,t)
\end{equation}
with the left boundary condition
\begin{equation}
...
\begin{equation}
  \frac{d\mathcal G^{(2)}_{nn}(t)}{dt} = -(\lambda_1^++\lambda_1^-)\mathcal G^{(2)}_{nn}(t) + \lambda_1^+(N-1)\mathcal G^{(1)}_n(t)
\end{equation}
At stationarity
\begin{equation}
  \mathcal G^{(2)}_{nn}(t) = \frac{\lambda_1^+(N-1)}{\lambda_1^++\lambda_1^-}\mathcal G^{(1)}_n(t).
\end{equation}

\subsubsection{Gene-mRNA}
\begin{multline}
  \frac{\partial\mathcal G^{(2)}_{nm}(\xi, t)}{\partial t} = \lambda_1^+NR(\xi,t) - \frac{1}{\tau_1}\mathcal G^{(2)}_{nm}(\xi,t) %+ \lambda_2\langle n^2\rangle(t)\delta(\xi)
...
\begin{multline}
  \frac{\partial\mathcal G^{(2)}_{m^2}(\xi, t)}{\partial t} = \frac{\partial}{\partial\xi}\left(D_m(\xi,t)\frac{\partial\mathcal G^{(2)}_{m^2}(\xi,t)}{\partial\xi}\right) - \frac{\partial}{\partial\xi}\left( v_m(\xi,t)\mathcal G^{(2)}_{m^2}(\xi,t)\right) - \frac{1}{\tau_2}G^{(2)}_{m^2}(\xi,t)
\end{multline}
with boundary conditions
\begin{align}
  &-D_m(\xi=0,t)\left.\frac{\partial\mathcal G^{(2)}_{m^2}}{\partial\xi}\right|_{\xi=0}(\xi,t) + v_m(\xi=0,t)\mathcal G^{(2)}_{m^2}(\xi=0,t) = \lambda_2\mathcal G^{(2)}_{nm}(0,t),\\
  &-D_m(\xi=L,t)\left.\frac{\partial\mathcal G^{(2)}_{m^2}}{\partial\xi}\right|_{\xi=L}(\xi,t) + v_m(\xi=L,t)\mathcal G^{(2)}_{m^2}(\xi=L,t) = 0.
\end{align}
...
\begin{multline}
  \frac{\partial\mathcal G^{(2)}_{mm}(\xi_1,\xi_2, t)}{\partial t} = \\
...
\begin{align}
  ...
  &-D_m(L,t)\left.\frac{\partial\mathcal G^{(2)}_{mm}}{\partial\xi_2}\right|_{\xi_1=L}(\xi_1,t) + v_m(L,t)\mathcal G^{(2)}_{mm}(\xi_1=0,\xi_2=L,t) = 0,%\\
  %& \mathcal G^{(2)}_{mm}(\xi,\xi,t) = \mathcal G^{(2)}_{m^2}(\xi,t) - \mathcal G^{(1)}(\xi,t).
\end{align}
...
\begin{multline}
  \frac{\partial\mathcal G^{(2)}_{ml}(\xi_1,\xi_2, t)}{\partial t} \\ =\frac{\partial}{\partial\xi_1}\left(D_m(\xi_1,t)\frac{\partial\mathcal G^{(2)}_{ml}(\xi_1,\xi_2,t)}{\partial\xi_1}\right) - \frac{\partial}{\partial\xi_1}\left( v_m(\xi_1,t)\mathcal G^{(2)}_{ml}(\xi_1,\xi_2,t)\right) - \frac{1}{\tau_2}G^{(2)}_{ml}(\xi_1,\xi_2,t)\\
