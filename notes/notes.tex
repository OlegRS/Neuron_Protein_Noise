...
\begin{equation}
  \begin{split}
    ...
    \textcolor{blue}{-\sum_{\mu=0}^{L-2}\Bigg[\nu_{\mu,\mu+1}(x_{m_\mu}-x_{m_{\mu+1}})\frac{\partial\mathcal G(\mathbf x, t)}{\partial x_{m_\mu}} + \nu_{\mu+1,\mu}(x_{m_{\mu+1}}-x_{m_\mu})\frac{\partial\mathcal G(\mathbf x, t)}{\partial x_{m_{\mu+1}}} } \\
      \textcolor{blue}{+\theta_{\mu,\mu+1}(x_{l_\mu}-x_{l_{\mu+1}})\frac{\partial\mathcal G(\mathbf x, t)}{\partial x_{l_\mu}} + \theta_{\mu+1,\mu}(x_{l_{\mu+1}}-x_{l_\mu})\frac{\partial\mathcal G(\mathbf x, t)}{\partial x_{l_{\mu+1}}}\Bigg]},
  \end{split}
\end{equation}
