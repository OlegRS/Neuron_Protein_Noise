...
\begin{equation}
  P(\xi) = \frac{2\lambda_2\langle n\rangle\kappa}{v_m+\sqrt{v_m^2+\frac{4D_m}{\tau_2}}}\frac{1}{(\lambda_--\Lambda_-)(\Lambda_+-\lambda_-)}\left(\mathrm e^{\lambda_-\xi} + \frac{1}{\Lambda_+}\left[\lambda_--\frac{v_p}{D_p}\right]\mathrm e^{\Lambda_-\xi} \right),
\end{equation}
where
\begin{equation}
...
\textcolor{red}{Why the second exponent comes with the opposite sign? This gives negative results with our parameters! Must be a mistake!}
